...
ITEM_CATALOG = {
    "⚠️ Illegal Fishing Gear": {
        ...
        "🍼 Copium Inhaler": {
            "type": "Consumable",
            "price": 100000,
            "desc": "makes you have +1% chance plus karma to catch a `Legendary 👑` tier for exactly one cast. If you still catch an `Old Boot`, the bot publicly pings you to laugh at your horrible luck."
        },
        "🧼 Gamer Girl Bathwater": {
            "type": "Lure",
            "price": 50000,
            "desc": "Guarantees your next 3 catches will exclusively be from the `Exceptional 🟤` or `Master 🏆` tiers."
        }
    },
    "📉 Market Manipulation": {
    ...
    "🗑️ Server Degeneracy": {
        "♻️ Discord Mod Application": {
            "type": "Passive",
            "price": 500000,
            "desc": "Makes you legally immune to catching `Wet Cardboard`. However, it doubles your chance of catching `Uncommon 🟢`."
        },
        "🧢 The \"I Have a Boyfriend\" Repellent": {
            "type": "Passive",
            "price": 1000000,
            "desc": "Completely blocks the `Remarkable 🟠` tier from spawning. You will either catch total trash or something incredibly rare, with zero in-between."
        }
    }
}
...
CREW_CATALOG = {
    "Rimach The Fisherman": {
        "base_cost": 1000,
        "cost_multiplier": 1.5,
        "assigned_tiers": ["Uncommon 🟢", "Remarkable 🟠"],
        "base_production": 3.0,
    ...
    "Jim The Wolf": {
        "base_cost": 2500,
        "cost_multiplier": 1.6,
        "assigned_tiers": ["Rare 🔵", "Outstanding 🟣"],
        "base_production": 1.5,
    ...
    "Magician Oceans Red": {
        "base_cost": 7500,
        "cost_multiplier": 1.7,
        "assigned_tiers": ["Exceptional 🟤", "Strange 💠"],
        "base_production": 0.8,
    ...
    "Katratzoglou": {
        "base_cost": 75000,
        "cost_multiplier": 2.0,
        "assigned_tiers": ["Elite 💎", "Legendary 👑"],
        "base_production": 0.1,
